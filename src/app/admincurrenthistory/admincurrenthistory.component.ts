...
@Component({
  selector: 'app-admincurrenthistory',
  standalone: true,
  imports: [NgxPaginationModule, CommonModule],
  templateUrl: './admincurrenthistory.component.html',
  styleUrl: './admincurrenthistory.component.css'
})
export class AdmincurrenthistoryComponent {

  currentHistory: any[] = [];
    currentPage: number = 1;
    errorMessage: string = '';
    private httpcrudService = inject(PasthistoryService);
